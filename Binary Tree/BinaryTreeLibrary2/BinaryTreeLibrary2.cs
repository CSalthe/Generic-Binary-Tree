...
// CIS 200-01
// D7090
// This class defines the rules for creating tree data structures and defines methods for in, pre and post order traversals of the tree objects
using System;
...
namespace BinaryTreeLibrary2
{
    ...
    class TreeNode<T> where T : IComparable<T>
    {
        ...
        //Precondition: variable is sent to method
